...
--job-template-parameters '{
    ...
    "CustomImageURI": "public.ecr.aws/myang-poc/celeborn-rss:emr7.0_clbtest",
    ...
    "RSS_server": "celeborn-spark3-5-master-0.celeborn-spark3-5-master-svc.celeborn:9097,celeborn-spark3-5-master-1.celeborn-spark3-5-master-svc.celeborn:9097,celeborn-spark3-5-master-2.celeborn-spark3-5-master-svc.celeborn:9097",
